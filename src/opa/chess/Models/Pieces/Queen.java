...
public class Queen extends Piece {
    ...
    public Queen(Location location, boolean color, int x, int y) {
        super(location, color, x, y, QUEEN);
    }
    ...
    @Override
    public Piece clone() {
        return new Queen(this.location, this.color, this.X, this.Y).setFirstMove(this.firstMove);
    }
}
